...
import ListaBusquedaEmpresaOParticular from "./ListaBusquedaEmpresaOParticular"; // Ajusta la ruta según sea necesario
...
const BuscarEmpresaPorNombre = ({ onSeleccionar, getToken }) => {
  ...
  return (
    <>
      ...
      {showResults && <ListaBusquedaEmpresaOParticular resultados={resultados} onSeleccionar={handleSeleccionar} />}
    </>
  );
};
